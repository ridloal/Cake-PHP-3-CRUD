...
<body>
    <!-- Page Nav Bar -->
    <nav class="navbar navbar-findcond navbar-fixed-top" style="background: #3d7221; marg">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="http://localhost/mitla_practice_cake/" style="color: white;">MITLA Practice</a>
        </div>
    ...
    <!-- Footer -->
    <footer class="section footer-classic context-dark bg-image navbar navbar-fixed-bottom" style="background: #3d7221;">
        <div class="container">
